  ...
  render: function() {
    return (
      <form id="search-language-country" ref="form" onSubmit={this.handleSubmit}>
        ...
        <datalist id="json-datalist"></datalist> within <input type="text" placeholder="e.g., Web Development" ref="subcategory" />.
        I am willing to spend up to $<input type="text" placeholder="Select range" ref="hourlyRateMax"/>/hr. 
